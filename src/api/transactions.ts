...
import { TransactionsReqQueries, TransactionsRes, TransactionTypes } from "../types";

export async function getTransactions(this: TransactionsReqQueries): Promise<TransactionsRes> {
    ...
    if (this.depositTypes && this.transactionType !== TransactionTypes.withdrawal && this.depositTypes.length > 0)
        this.depositTypes.forEach((depType) => queries.push("deposit-type=" + depType))
